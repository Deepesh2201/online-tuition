        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 profileSec1">
                ...
                <div class="aboutTutor review-top">
                    ...
                    <div class="star">
                        <span>
                            <i class="fa fa-star"></i> {{$averagereview->avg_rating ?? '0'}} ({{$averagecount ?? '0'}}
                            reviews)
                        </span>
                    </div>
                </div>
                ...
                <div class="tutorDetails tutorProfPic mar-top-40">
                    <div class="row">
                        <div class="col-lg-12 col-md-5">
                            ...
                            <img src="{{ url('images/tutors/profilepics', '/') }}{{ $tutorpd->profile_pic }}" width="100%" alt="" onerror="this.onerror=null;this.src='https://mychoicetutor.com/frontendnew/img/icons/mct-favicon.png';">
                            </div>
                        </div>
            ...
            <a href="/tutor-details/{{$othertutor->tutor_id}}" style="color: black">
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 tutorCol">
                    <div class="tutorDetails padd-200">
                        <div class="tutorImg">
                            <img src="{{ url('images/tutors/profilepics', '/') }}{{ $othertutor->profile_pic  }}" width="100%" alt="" onerror="this.onerror=null;this.src='https://mychoicetutor.com/frontendnew/img/icons/mct-favicon.png';">
                        </div>
                        <div class="star">
                            <span>
                                <i class="fa fa-star"></i>
